      ...
      <div className="mb-4">
        ...
        <div className="space-y-1.5">
          {groupMatches.map((match, index) => {
            const isCurrent = tournamentPhase !== "complete" && index === currentMatchIndex;
            const isPast = tournamentPhase === "complete" || index < currentMatchIndex;
            return (
              <div
                key={index}
              ...
              >
                <span className="font-semibold text-gray-400">Match {index + 1}</span>
